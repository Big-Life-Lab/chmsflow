...
1. Load required packages, functions, and worksheets (variables and variable details sheets). See README.md in GitHub to see how packages can be loaded at the RDC. SECTION WILL BE REMOVED WHEN PACKAGE POSTED!
```{r}
