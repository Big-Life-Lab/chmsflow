...
2. Recode medication variables for individual cycles, with each cycle's medication data being separate from the rest of their respective data. 

Medication data object always has to be called "cyclex_meds" in order for recoding to work properly, with rest of the data being called "cyclex" as stated in recoding-variables.qmd. 
...
4. If you need medication variables in your analyis (especially to derive other variables), always recode them before recoding other variables.
