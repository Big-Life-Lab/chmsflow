...
- **Medication recoding details** -- [Recoding medications](recoding_medications.html)
- **Understanding the metadata** -- [Variable schema reference](variables_and_variable_details.html)
- **Derived variables** -- [Derived variables](derived_variables.html)
- **Missing data** -- [Missing data (tagged_na)](tagged_na_usage.html)
