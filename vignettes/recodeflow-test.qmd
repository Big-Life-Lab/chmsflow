...
cycle6_ages <- recodeflow::rec_with_table(cycle6, "CLC_AGE", variable_details = my_variable_details, log = TRUE, var_labels = c(CLC_AGE = "AGE"))
cycle6_sexes <- recodeflow::rec_with_table(cycle6, "CLC_SEX", variable_details = my_variable_details, log = TRUE, var_labels = c(CLC_SEX = "SEX"))
