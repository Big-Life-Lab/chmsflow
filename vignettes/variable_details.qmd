...
```{r Read variables.csv, echo=FALSE, message=FALSE, warning=FALSE, eval=FALSE}
library(readr)
library(DT)
library(knitr)
library(kableExtra)
...
4. **databaseStart:** the CHMS cycles that contain the variable of interest, separated by commas. Each cycle's medication data is separate from the rest of their respective data.
