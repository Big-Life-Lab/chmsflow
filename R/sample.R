#' @brief Determine the inclusion status of a respondent in the study sample
#'
#' @param agegroup2079 An integer indicating whether the respondent's age falls within the range of 20 to 79 years. 
#'                     1 for "Yes", 2 for "No".
#' @param highBP14090 An integer indicating whether the respondent has hypertension (high blood pressure). 
#'                    1 for "Yes", 2 for "No".
...
#'
#' @details The function evaluates the input variables `agegroup2079`, `highBP14090`, and `PRS_11` to determine the 
...
#'          they do not have a hypertension non-response (highBP14090 is not NA), and they are not pregnant (PRS_11 is not 1), the function 
#'          sets `insample` to 1, indicating that the respondent is eligible for inclusion in the study sample. Otherwise, 
...
#' # The respondent's age is between 20 and 79, they do not have hypertension (highBP14090 is 2), and they are not pregnant (PRS_11 is 2).
#' determine_inclusion_status(agegroup2079 = 1, highBP14090 = 2, PRS_11 = 2)
