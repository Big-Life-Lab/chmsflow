...
#' )
#'
#' get_label(cycle1_ages)
#'
#' labeled_cycle1_ages <- set_data_labels(cycle1_ages,
#'  variable_details,
#'  variables)
#'
#' get_label(labeled_cycle1_ages)
#' @export
set_data_labels <-
...
#' @importFrom sjlabelled sjlabelled::set_labels set_label set_label<-
#'
