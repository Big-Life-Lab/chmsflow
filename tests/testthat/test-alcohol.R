...
test_that("low_drink_score_fun1 returns correct scores", {
  expect_equal(low_drink_score_fun1(CLC_SEX = 1, ALCDWKY = 3, ALC_17 = 1, ALC_11 = 2), 2, info = "Low risk for male who drank in the past year")
  expect_equal(low_drink_score_fun1(CLC_SEX = 2, ALCDWKY = 3, ALC_17 = 1, ALC_11 = 2), 2, info = "Low risk for female who drank in the past year")
  expect_equal(low_drink_score_fun1(CLC_SEX = 1, ALCDWKY = 12, ALC_17 = 1, ALC_11 = 2), 2, info = "Low risk for male who drank in the past year")
  ...
  expect_equal(low_drink_score_fun1(CLC_SEX = 2, ALCDWKY = 25, ALC_17 = 1, ALC_11 = 1), 4, info = "High risk for female who drank in the past year")
