...
test_that("low_drink_score_fun1 returns correct scores", {
  ...
  expect_equal(low_drink_score_fun1(CLC_SEX = 1, ALCDWKY = NA, ALC_17 = 1, ALC_11 = 2, ALC_18 = 2), 1) # Former drinker, no heavy
  expect_equal(low_drink_score_fun1(CLC_SEX = 1, ALCDWKY = NA, ALC_17 = 1, ALC_11 = 2, ALC_18 = 1), 2) # Former drinker, heavy
  expect_equal(low_drink_score_fun1(CLC_SEX = 1, ALCDWKY = 3, ALC_17 = 1, ALC_11 = 1, ALC_18 = 1), 2) # Low risk male
  expect_equal(low_drink_score_fun1(CLC_SEX = 2, ALCDWKY = 3, ALC_17 = 1, ALC_11 = 1, ALC_18 = 1), 2) # Low risk female
  expect_equal(low_drink_score_fun1(CLC_SEX = 1, ALCDWKY = 12, ALC_17 = 1, ALC_11 = 1, ALC_18 = 1), 2) # Low risk male
  expect_equal(low_drink_score_fun1(CLC_SEX = 2, ALCDWKY = 12, ALC_17 = 1, ALC_11 = 1, ALC_18 = 1), 3) # Marginal risk female
  expect_equal(low_drink_score_fun1(CLC_SEX = 1, ALCDWKY = 18, ALC_17 = 1, ALC_11 = 1, ALC_18 = 1), 3) # Marginal risk male
  expect_equal(low_drink_score_fun1(CLC_SEX = 2, ALCDWKY = 18, ALC_17 = 1, ALC_11 = 1, ALC_18 = 1), 4) # High risk female
  expect_equal(low_drink_score_fun1(CLC_SEX = 1, ALCDWKY = 25, ALC_17 = 1, ALC_11 = 1, ALC_18 = 1), 4) # High risk male
  expect_equal(low_drink_score_fun1(CLC_SEX = 2, ALCDWKY = 25, ALC_17 = 1, ALC_11 = 1, ALC_18 = 1), 4) # High risk female
